...
let arr = [
  {
    ...
    project: "cognizant Intern",
    HCM: "Harry",
    placeholder:
      "https://cdn3.vectorstock.com/i/thumb-large/55/92/person-gray-photo-placeholder-woman-vector-24715592.jpg",
  },
  {
    Name: "Raj Laxmi",
    ID: 2,
  ...
  },
  {
    ...
    HCM: "Harry",
    placeholder:
      "https://cdn2.vectorstock.com/i/thumb-large/46/76/person-gray-photo-placeholder-man-material-design-vector-23804676.jpg",
  },
  {
    Name: "Shreya",
    ID: 5,
...
for (let obj of arr) {
  ...
  cell6.innerHTML =
    '<i class="far fa-edit" onclick="edit(' + arr.indexOf(obj) + ')"></i>';
  cell6.id = "ed" + arr.indexOf(obj);
  cell7.innerHTML =
    '<i class="far fa-minus-square" onclick="odelete(' +
    arr.indexOf(obj) +
    ')"></i>';
}
...
for (let obj of arr) {
  ...
  el.appendChild(elh);
  elh.innerHTML =
    '<i class="fas fa-times" style="color:red;float:right;font-size:20px;cursor:pointer" onclick="odeletec(' +
    arr.indexOf(obj) +
    ')"></i>';
  ...
  el.appendChild(elf);
  elf.innerHTML =
    '<button class="btn btn-success" style="margin-bottom:10px;margin-left:50px" onclick="editc(' +
    arr.indexOf(obj) +
    ')">Edit</button> <button class="btn btn-primary" style="margin-bottom:10px;float:right;margin-right:50px" onclick="savec(' +
    arr.indexOf(obj) +
    ')">Save</button>';
